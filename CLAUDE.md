...
- Official brand assets added under `assets/img/` (PNG favicon set + horizontal lockups); the placeholder `favicon.svg` was removed and pages now link the PNG favicons.
